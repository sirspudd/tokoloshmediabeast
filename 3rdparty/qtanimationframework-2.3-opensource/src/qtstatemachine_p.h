...
public:
    ...
    QPair<QList<QtAbstractAnimation*>, QList<QtAbstractAnimation*> >
        initializeAnimation(QtAbstractAnimation *abstractAnimation, 
                            const QPropertyAssignment &prop);

    QList<QPair<QtAbstractAnimation*, QPropertyAssignment> > propertiesForAnimations;
    QList<QtAbstractAnimation*> playingAnimations;
    QList<QtAbstractAnimation*> resetEndValues;
#endif
